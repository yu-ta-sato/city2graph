...
def load_overture_data(
    ...
    area : Union[List[float], Polygon]
        Either:
        - A bounding box as [min_lon, min_lat, max_lon, max_lat] in WGS84 coordinates
        - A Polygon in WGS84 coordinates (EPSG:4326). If provided in another CRS,
    ...
    types : Optional[List[str]], default=None
        ...
        Must be valid Overture Maps data types of following:
            "address", "bathymetry", "building", "building_part",
            "division", "division_area", "division_boundary", "place",
            "segment", "connector", "infrastructure", "land",
