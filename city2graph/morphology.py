...
def morphological_graph(
    ...
    private_id_col : str, optional
        Column name for private space identifiers in the tessellation generated by buildings_gdf and segments_gdf.
        If None, defaults to "private_id". If the column doesn't exist, it will be created.
    public_id_col : str, optional
        Column name for public space identifiers in `segments_gdf`.
        If None, defaults to "public_id". If the column doesn't exist, it will be created
    ...
    segments_gdf, pub_id_col = _ensure_id_column(
    ...
    # Rename tessellation ID column to "private_id"
    tessellation = tessellation.rename(columns={"tess_id": "private_id"})

    tessellation, priv_id_col = _ensure_id_column(
    ...
    priv_priv = private_to_private_graph(
        tessellation,
        private_id_col=priv_id_col,
        group_col="enclosure_index",
        contiguity=contiguity,
    )
    pub_pub = public_to_public_graph(segs, public_id_col=pub_id_col)
    priv_pub = private_to_public_graph(
        tessellation,
        segs,
        private_id_col=priv_id_col,
        public_id_col=pub_id_col,
    ...
    nodes = {
        "private": _set_index_if_exists(tessellation, priv_id_col),
        "public": _set_index_if_exists(segs, pub_id_col),
    }
    edges = {
...
def private_to_private_graph(
    ...
    private_id_col : str, optional
        Column name to use for private space identifiers. If None, uses "private_id".
    ...
    private_id_col = private_id_col or "private_id"
    ...
    private_gdf, private_id_col = _ensure_id_column(private_gdf, private_id_col, "private_id")
...
def private_to_public_graph(
    ...
    private_id_col : str, optional
        Column name for private space identifiers. If None, uses "private_id".
    public_id_col : str, optional
        Column name for public space identifiers. If None, uses "public_id".
    primary_barrier_col : str, optional
    ...
    private_id_col = private_id_col or "private_id"
    public_id_col = public_id_col or "public_id"
    private_gdf, private_id_col = _ensure_id_column(private_gdf, private_id_col, "private_id")
